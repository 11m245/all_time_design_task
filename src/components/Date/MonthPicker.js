...
function MonthHeader({ viewDate, setViewDate, setShowPage }) {
  return (
    <>
      <div className="month-header">
        ...
        <div className="year-name title" onClick={() => setShowPage("year")}>
...
function Months({ viewDate, setViewDate, setShowPage }) {
  const months = [
    "Jan",
    "Feb",
    "Mar",
      ...
      <div className="months-container">
        {months.map((monthName, i) => (
          <button
            ...
            onClick={() => {
              setViewDate(
                new Date(viewDate.getFullYear(), i, viewDate.getDate())
              );
              setShowPage("date");
            }}
          >
